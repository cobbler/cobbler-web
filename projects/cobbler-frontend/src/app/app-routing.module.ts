...
import { DistroGroupEditComponent } from './items/distro-group/edit/distro-group-edit.component';
import { DistroGroupOverviewComponent } from './items/distro-group/overview/distro-group-overview.component';
import { ProfileGroupEditComponent } from './items/profile-group/edit/profile-group-edit.component';
import { ProfileGroupOverviewComponent } from './items/profile-group/overview/profile-group-overview.component';
import { SystemGroupEditComponent } from './items/system-group/edit/system-group-edit.component';
import { SystemGroupOverviewComponent } from './items/system-group/overview/system-group-overview.component';
...
import { DistroGroupShellComponent } from './items/distro-group/distro-group-shell.component';
import { ProfileGroupShellComponent } from './items/profile-group/profile-group-shell.component';
import { SystemGroupShellComponent } from './items/system-group/system-group-shell.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'distro-group',
        component: DistroGroupShellComponent, // Shell
        canActivate: [AuthGuardService],
        children: [
          {
            path: '',
            component: DistroGroupOverviewComponent,
            canActivate: [AuthGuardService],
            data: {
              breadcrumb: $localize`:@@breadcrumb.items.distro-group:Distro Groups`,
            },
          },
          {
            path: ':name',
            component: DistroGroupEditComponent,
            canActivate: [AuthGuardService],
            data: { breadcrumb: { alias: 'itemName' } },
          },
        ],
      ...
      {
        path: 'profile-group',
        component: ProfileGroupShellComponent, // Shell
        canActivate: [AuthGuardService],
        children: [
          {
            path: '',
            component: ProfileGroupOverviewComponent,
            canActivate: [AuthGuardService],
            data: {
              breadcrumb: $localize`:@@breadcrumb.items.profile-group:Profile Groups`,
            },
          },
          {
            path: ':name',
            component: ProfileGroupEditComponent,
            canActivate: [AuthGuardService],
            data: { breadcrumb: { alias: 'itemName' } },
          },
        ],
      ...
      {
        path: 'system-group',
        component: SystemGroupShellComponent, // Shell
        canActivate: [AuthGuardService],
        children: [
          {
            path: '',
            component: SystemGroupOverviewComponent,
            canActivate: [AuthGuardService],
            data: {
              breadcrumb: $localize`:@@breadcrumb.items.system-group:System Groups`,
            },
          },
          {
            path: ':name',
