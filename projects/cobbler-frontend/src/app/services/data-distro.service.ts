...
export class DataDistroService {
  ...
  autoinstall: ['autoinstall_meta', {}, 0, 'Automatic Installation Template Metadata', true, 'Ex: dog=fang agent=86', 0, 'dict'],
  b_files: ['boot_files', {}, 0, 'TFTP Boot Files', true, 'Files copied into tftpboot beyond the kernel/initrd', 0, 'list'],
  b_loader: ['boot_loader', '<<inherit>>', 0, 'Boot loader', true, 'Network installation boot loader', 'utils.get_supported_system_boot_loaders()', 'str'],
  ...
  k_opt_post: ['kernel_options_post', {}, 0, 'Kernel Options (Post Install)', true, 'Ex: clocksource=pit noapic', 0, 'dict'],
  mng_class: ['mgmt_classes', [], 0, 'Management Classes', true, 'Management classes for external config management', 0, 'list'],
  name: ['name', '', 0, 'Name', true, 'Ex: Fedora-11-i386', 0, 'str'],
  os_version: ['os_version', 'virtio26', 0, 'OS Version', true, 'Needed for some virtualization optimizations', 'utils.get_valid_os_versions()', 'str'],
  ...
  tmplt_files: ['template_files', {}, 0, 'Template Files', true, 'File mappings for built-in config management', 0, 'dict']
