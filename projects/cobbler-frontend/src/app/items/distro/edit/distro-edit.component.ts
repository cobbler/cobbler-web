  ...
  refreshData(): void {
    this.cobblerApiService.get_distro(this.name, false, false, this.userService.token).subscribe(value => {
      ...
      if (typeof this.distro.fetchable_files === "string") {
        this.distroFormGroup.controls.fetchable_files_inherited.setValue(true)
      } else {
        this.distroFormGroup.controls.fetchable_files_inherited.setValue(false)
        this.distroFormGroup.controls.fetchable_files.setValue(this.distro.fetchable_files)
      }
      if (typeof this.distro.kernel_options === "string") {
        this.distroFormGroup.controls.kernel_options_inherited.setValue(true)
      } else {
        this.distroFormGroup.controls.kernel_options_inherited.setValue(false)
        this.distroFormGroup.controls.kernel_options.setValue(this.distro.kernel_options)
      }
      if (typeof this.distro.kernel_options_post === "string") {
        this.distroFormGroup.controls.kernel_options_post_inherited.setValue(true)
      } else {
        this.distroFormGroup.controls.kernel_options_post_inherited.setValue(false)
        this.distroFormGroup.controls.kernel_options_post.setValue(this.distro.kernel_options_post)
      }
      if (typeof this.distro.template_files === "string") {
        this.distroFormGroup.controls.template_files_inherited.setValue(true)
      } else {
        this.distroFormGroup.controls.template_files_inherited.setValue(false)
        this.distroFormGroup.controls.template_files.setValue(this.distro.template_files)
      }
    }, error => {
