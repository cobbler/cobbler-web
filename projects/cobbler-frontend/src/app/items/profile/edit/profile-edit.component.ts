...
export class ProfileEditComponent implements OnInit{
  ...
  refreshData(): void {
    this.cobblerApiService.get_profile(this.name, false, false, this.userService.token).subscribe(value => {
      this.profile = value
      ...
      this.profileFormGroup.controls.mtime.setValue(new Date(this.profile.mtime * 1000).toString())
      this.profileFormGroup.controls.ctime.setValue(new Date(this.profile.ctime * 1000).toString())
      ...
      this.profileFormGroup.controls.name_servers.setValue(this.profile.name_servers)
      this.profileFormGroup.controls.name_servers_search.setValue(this.profile.name_servers_search)
      ...
      if (typeof this.profile.boot_loaders === "string") {
        ...
        this.profileFormGroup.controls.boot_loaders.setValue(this.profile.boot_loaders)
      }
      ...
      if (typeof this.profile.boot_files === "string") {
        ...
        this.profileFormGroup.controls.boot_files.setValue(this.profile.boot_files)
      }
      if (typeof this.profile.fetchable_files === "string") {
        this.profileFormGroup.controls.fetchable_files_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.fetchable_files_inherited.setValue(false)
        this.profileFormGroup.controls.fetchable_files.setValue(this.profile.fetchable_files)
      }
      if (typeof this.profile.kernel_options === "string") {
        this.profileFormGroup.controls.kernel_options_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.kernel_options_inherited.setValue(false)
        this.profileFormGroup.controls.kernel_options.setValue(this.profile.kernel_options)
      }
      if (typeof this.profile.kernel_options_post === "string") {
        this.profileFormGroup.controls.kernel_options_post_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.kernel_options_post_inherited.setValue(false)
        this.profileFormGroup.controls.kernel_options_post.setValue(this.profile.kernel_options_post)
      }
      if (typeof this.profile.mgmt_classes === "string") {
        this.profileFormGroup.controls.mgmt_classes_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.mgmt_classes_inherited.setValue(false)
        this.profileFormGroup.controls.mgmt_classes.setValue(this.profile.mgmt_classes)
      }
      if (typeof this.profile.mgmt_parameters === "string") {
        this.profileFormGroup.controls.mgmt_parameters_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.mgmt_parameters_inherited.setValue(false)
        this.profileFormGroup.controls.mgmt_parameters.setValue(this.profile.mgmt_parameters)
      }
      if (typeof this.profile.template_files === "string") {
        this.profileFormGroup.controls.template_files_inherited.setValue(true)
      } else {
        this.profileFormGroup.controls.template_files_inherited.setValue(false)
        this.profileFormGroup.controls.template_files.setValue(this.profile.template_files)
      }
    }, error => {
  ...
  removeProfile(): void {
    this.cobblerApiService.remove_profile(this.name, this.userService.token, false).subscribe(value => {
      if (value) {
  ...
  copyProfile(): void {
    this.cobblerApiService.copy_profile("", "", this.userService.token)
      .subscribe(value => {
        // TODO
      }, error => {
        // HTML encode the error message since it originates from XML
