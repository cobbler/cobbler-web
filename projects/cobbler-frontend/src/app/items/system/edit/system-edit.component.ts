...
export class SystemEditComponent implements OnInit {
  ...
  systemFormGroup = this._formBuilder.group({
    ...
    fetchable_files_inherited: new FormControl({value: false, disabled: true}),
    ...
    kernel_options_post_inherited: new FormControl({value: false, disabled: true}),
    ...
    mgmt_parameters_inherited: new FormControl({value: false, disabled: true}),
  ...
  refreshData(): void {
    this.cobblerApiService.get_system(this.name, false, false, this.userService.token).subscribe(value => {
      this.system = value
      this.systemFormGroup.controls.name.setValue(this.system.name)
      this.systemFormGroup.controls.uid.setValue(this.system.uid)
      this.systemFormGroup.controls.mtime.setValue(new Date(this.system.mtime * 1000).toString())
      this.systemFormGroup.controls.ctime.setValue(new Date(this.system.ctime * 1000).toString())
      this.systemFormGroup.controls.depth.setValue(this.system.depth)
      if (typeof this.system.virt_cpus !== "string") {
        this.systemFormGroup.controls.virt_cpus.setValue(this.system.virt_cpus)
      }
      if (typeof this.system.virt_file_size !== "string") {
        this.systemFormGroup.controls.virt_file_size.setValue(this.system.virt_file_size)
      }
      if (typeof this.system.virt_ram !== "string") {
        this.systemFormGroup.controls.virt_ram.setValue(this.system.virt_ram)
      }
      this.systemFormGroup.controls.serial_device.setValue(this.system.serial_device)
      this.systemFormGroup.controls.serial_baud_rate.setValue(this.system.serial_baud_rate)
      this.systemFormGroup.controls.is_subobject.setValue(this.system.is_subobject)
      this.systemFormGroup.controls.ipv6_autoconfiguration.setValue(this.system.ipv6_autoconfiguration)
      this.systemFormGroup.controls.repos_enabled.setValue(this.system.repos_enabled)
      this.systemFormGroup.controls.netboot_enabled.setValue(this.system.netboot_enabled)
      if (typeof this.system.virt_auto_boot !== "string") {
        // TODO: Show inheritance if string
        this.systemFormGroup.controls.virt_auto_boot.setValue(this.system.virt_auto_boot)
      }
      this.systemFormGroup.controls.virt_pxe_boot.setValue(this.system.virt_pxe_boot)
      this.systemFormGroup.controls.redhat_management_key.setValue(this.system.redhat_management_key)
      this.systemFormGroup.controls.autoinstall.setValue(this.system.autoinstall)
      ...
      this.systemFormGroup.controls.ipv6_default_device.setValue(this.system.ipv6_default_device)
      this.systemFormGroup.controls.next_server_v4.setValue(this.system.next_server_v4)
      this.systemFormGroup.controls.next_server_v6.setValue(this.system.next_server_v6)
      this.systemFormGroup.controls.filename.setValue(this.system.filename)
      this.systemFormGroup.controls.power_address.setValue(this.system.power_address)
      this.systemFormGroup.controls.power_id.setValue(this.system.power_id)
      this.systemFormGroup.controls.power_pass.setValue(this.system.power_pass)
      this.systemFormGroup.controls.power_type.setValue(this.system.power_type)
      this.systemFormGroup.controls.power_user.setValue(this.system.power_user)
      this.systemFormGroup.controls.power_options.setValue(this.system.power_options)
      this.systemFormGroup.controls.power_identity_file.setValue(this.system.power_identity_file)
      ...
      this.systemFormGroup.controls.virt_disk_driver.setValue(this.system.virt_disk_driver)
      this.systemFormGroup.controls.virt_path.setValue(this.system.virt_path)
      this.systemFormGroup.controls.virt_type.setValue(this.system.virt_type)
      this.systemFormGroup.controls.name_servers.setValue(this.system.name_servers)
      this.systemFormGroup.controls.name_servers_search.setValue(this.system.name_servers_search)
      if (typeof this.system.boot_loaders === "string") {
        ...
        this.systemFormGroup.controls.boot_loaders.setValue(this.system.boot_loaders)
      }
      ...
      if (typeof this.system.boot_files === "string") {
        ...
        this.systemFormGroup.controls.boot_files.setValue(this.system.boot_files)
      }
      if (typeof this.system.fetchable_files === "string") {
        this.systemFormGroup.controls.fetchable_files_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.fetchable_files_inherited.setValue(false)
        this.systemFormGroup.controls.fetchable_files.setValue(this.system.fetchable_files)
      }
      if (typeof this.system.kernel_options === "string") {
        this.systemFormGroup.controls.kernel_options_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.kernel_options_inherited.setValue(false)
        this.systemFormGroup.controls.kernel_options.setValue(this.system.kernel_options)
      }
      if (typeof this.system.kernel_options_post === "string") {
        this.systemFormGroup.controls.kernel_options_post_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.kernel_options_post_inherited.setValue(false)
        this.systemFormGroup.controls.kernel_options_post.setValue(this.system.kernel_options_post)
      }
      if (typeof this.system.mgmt_classes === "string") {
        this.systemFormGroup.controls.mgmt_classes_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.mgmt_classes_inherited.setValue(false)
        this.systemFormGroup.controls.mgmt_classes.setValue(this.system.mgmt_classes)
      }
      if (typeof this.system.mgmt_parameters === "string") {
        this.systemFormGroup.controls.mgmt_parameters_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.mgmt_parameters_inherited.setValue(false)
        this.systemFormGroup.controls.mgmt_parameters.setValue(this.system.mgmt_parameters)
      }
      if (typeof this.system.template_files === "string") {
        this.systemFormGroup.controls.template_files_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.template_files_inherited.setValue(false)
        this.systemFormGroup.controls.template_files.setValue(this.system.template_files)
      }
      if (typeof this.system.autoinstall_meta === "string") {
        this.systemFormGroup.controls.autoinstall_meta_inherited.setValue(true)
      } else {
        this.systemFormGroup.controls.autoinstall_meta_inherited.setValue(false)
        this.systemFormGroup.controls.autoinstall_meta.setValue(this.system.autoinstall_meta)
      }
    }, error => {
  ...
  removeSystem(): void {
    this.cobblerApiService.remove_system(this.name, this.userService.token, false).subscribe(value => {
      if (value) {
  ...
  copySystem(): void {
    this.cobblerApiService.copy_system("", "", this.userService.token)
      .subscribe(value => {
        // TODO
      }, error => {
        // HTML encode the error message since it originates from XML
