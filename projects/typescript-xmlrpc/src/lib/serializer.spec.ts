...
describe('serializeMethodCall', () => {
  ...
  it('function without parameters but with encoding', () => {
    ...
    expect(serializeMethodCall('function_name', undefined, 'UTF-8')).toBe(
      expectedResult,
    );
  });
  ...
  it('function with date parameter', () => {
    ...
    expect(serializeMethodCall('function_name', [new Date('1970-01-01')])).toBe(
      expectedResult,
    );
  });
  ...
  it('function with multiple parameters and encoding', () => {
    ...
    expect(serializeMethodCall('function_name', [41, 41], 'UTF-8')).toBe(
      expectedResult,
    );
  });
});
